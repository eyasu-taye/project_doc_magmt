...
.dropdown:hover .dropbtn {background-color: #101;}
  </style>
}
</head>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown"><a class="dropbtn"><span class="glyphicon glyphicon-user"></span></a>
  <div id="myDropdown" class="dropdown-content">
    <a onclick="myFunction()" id = "user_name_display">Edit</a>
    <a onclick="show_to_update_user()">Edit</a>
    <a href="/">Logout</a>
  </div>
</li>
    ...
    <div class="modal-content">
      ...
      <!-- Form -->
        <form id="update_user_data" method='post' action="" enctype="multipart/form-data">
          ...
          <input id="email_address_update" type="email" class="col-xs-12 btn btn-default" autofocus="true" style="border-radius: 5px red; text-align: right; display: block; float: left; row:1; left; margin-right: 5px;" placeholder="email_address" disabled="true">
...
$(document).ready(function(){
  ...
  var user = "{{$id1}}".split('@');
  document.getElementById("user_name_display").innerHTML = user[0];
    // document.getElementById("user_name_display").innerHTML = "{{$id1}}";
  ...
  // }
      ...
      function show_to_update_user(){
          ...
          function login1(){
                          ...
                          var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                          formData.append('_token', '{{csrf_token()}}');
                          formData.append('lgemail', 'admin@mint.gov.et');
                          formData.append('lgpassword', 'admin@mint.gov.et');
